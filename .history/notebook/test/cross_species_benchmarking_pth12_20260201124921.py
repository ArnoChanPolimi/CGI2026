...
# )
# logger = get_logger(
#     log_dir=str(LOG_DIR), log_filename="cross_species_benchmarking_pth12_letterbox.log"
# )
logger = get_logger(
    log_dir=str(LOG_DIR),
    log_filename="cross_species_benchmarking_pth12_letterbox_NoHealthy.log",
)
