...
BATCH_SIZE = 16  # 利用 32G 内存，提高 CPU 利用率
EPOCHS = 5  # 11GB 数据量大，先跑 5 轮查看效果
...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        # 每一轮保存一个模型，防止断电
        torch.save(model.state_dict(), SAVE_DIR / f"checkpoint_epoch_{epoch+1}.pth")
