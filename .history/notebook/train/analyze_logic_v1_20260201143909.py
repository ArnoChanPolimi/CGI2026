...
try:
    ...
    epoch_val = re.findall(r"(\d+)", MODEL_PATH.name)[0]
...
LOSS_PLOT_PATH = VIS_OUT_DIR / f"loss_Acc_logic_v1_{ver_tag}_letterbox.png"
...
def analyze():
    ...
    try:
        ...
        # --- ✨ 额外增加的日志存档路径 ---
        METRICS_CSV = VIS_OUT_DIR / f"backtrack_metrics_logic_v1_{ver_tag}.csv"
