...
# --- ✨ 文件路径分配 (加入 ver_tag) ---
ERROR_CSV_FILE = ERROR_OUT_DIR / f"all_misclassified_cases_logic_v1_{ver_tag}.csv"
CROP_REPORT_FILE = ERROR_OUT_DIR / f"crop_error_diagnosis_logic_v1_{ver_tag}.csv"
LOSS_PLOT_PATH = SAVE_DIR / f"loss_trend_logic_v1_{ver_tag}.png"
CM_PLOT_PATH = SAVE_DIR / f"confusion_matrix_logic_v1_{ver_tag}.png"

# 日志文件名也建议对齐版本，方便回溯
logger = get_logger(
    log_dir=str(SAVE_DIR), log_filename=f"logic_v1_analysis_{ver_tag}.log"
)
