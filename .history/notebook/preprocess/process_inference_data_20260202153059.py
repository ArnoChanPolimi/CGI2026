...
# 实战原始大图路径
INPUT_DIR = Path(
    r"D:\AA_POLIMI\POLIMI_STUDING\SEM3\COMMUNICATION_IN_GREEN_INFRASTRUCTURES\CGI_PROJECT\OTHER"
)
# 实战切片保存路径
OUTPUT_ROOT = Path(
    r"D:\AA_POLIMI\POLIMI_STUDING\SEM3\COMMUNICATION_IN_GREEN_INFRASTRUCTURES\CGI_PROJECT\data_processed\inference"
)
