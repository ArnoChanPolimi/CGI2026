...
IMAGE_RELATIVE_PATHS_TO_ANALYZE = [
    "data/raw_data/test/Apple_Scab/image_200.jpg",
    "data/raw_data/test/Tomato_healthy/image_10.jpg",
    "data/raw_data/test/Potato_Early_blight/image_50.jpg",
    "data/raw_data/test/Corn_Gray_leaf_spot/image_15.jpg",
    # 可以继续添加你感兴趣的图片路径
]
