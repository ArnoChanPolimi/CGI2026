...
if __name__ == "__main__":
    ...
    for rel_path in tqdm(IMAGE_RELATIVE_PATHS_TO_ANALYZE):
        ...
        if full_path.exists():
            visualize_grad_cam_triple(
                model, layer13, layer_neg2, full_path, preprocess, OUTPUT_DIR, pth_tag
            )
