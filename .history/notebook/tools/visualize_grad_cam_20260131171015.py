...
IMAGE_RELATIVE_PATHS_TO_ANALYZE = [
    # 01_Chilli
    "raw_data\01_Chilli\abiotic\Chilli Nutrition Deficiency/Nutrition Deficiency00050.JPG",  # 正确识别案例 True Positive
    "RAW_DATA/01_Chilli/abiotic/Nutrition Deficiency/image_851.jpg",  # 错误识别案例 False Negative
    "RAW_DATA\01_Chilli\abiotic\Chili Healthy Leaf\Healthy Leaf00061.JPG",  # healthy False Positive
    # 02_Tomato
    "raw_data\02_Tomato\abiotic\Magnesium Deficiency/Magnesium Deficiency_26.jpg",  # True Positive
    "RAW_DATA\02_Tomato\abiotic\Magnesium Deficiency\Magnesium Deficiency_113.jpg",  # False Negative
    "RAW_DATA\02_Tomato\abiotic\Healthy\Healthy_15.jpg",  # healthy False Positive
    # 07_Mazie (玉米)
    "RAW_DATA/07_Mazie/biotic/Corn_Gray_leaf_spot/image_a.jpg",
