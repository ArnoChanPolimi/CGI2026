...
def main():
    ...
    MODEL_PATH = ROOT_DIR / "output" / "All_crop_train_logic_v1" / "checkpoint_epoch_letterbox_12.pth"
    ...
    preprocess_vis = transforms.Compose([LetterboxResize(256), transforms.CenterCrop(224)])
