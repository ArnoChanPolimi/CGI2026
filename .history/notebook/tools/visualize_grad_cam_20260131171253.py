...
IMAGE_RELATIVE_PATHS_TO_ANALYZE = [
    # 01_Chilli (辣椒)
    "RAW_DATA/01_Chilli/abiotic/Chilli Nutrition Deficiency/Nutrition Deficiency00050.JPG",  # 正确
    ...
    # 02_Tomato (番茄)
    "RAW_DATA/02_Tomato/abiotic/Magnesium Deficiency/Magnesium Deficiency_26.jpg",  # 正确
    ...
    # 03_Carambola (杨桃)
    "RAW_DATA/03_Carambola/abiotic/Healthy/Augmented_0_1941.jpeg",  # 请替换实际文件名
    "RAW_DATA/03_Carambola/biotic/Algal_Leaf_Spot/image_2.jpg",
    # 04_Guava (番石榴)
    "RAW_DATA/04_Guava/abiotic/Nutritional Deficiency/image_3.jpg",  # 请替换实际文件名
    "RAW_DATA/04_Guava/biotic/Canker/image_4.jpg",
    # 05_cherry (樱桃)
    "RAW_DATA/05_cherry/abiotic/Localized Damage/image_5.jpg",  # 请替换实际文件名
    "RAW_DATA/05_cherry/biotic/Fungal Leaf Spot/image_6.jpg",
    # 06_Jackfruit (菠萝蜜)
    "RAW_DATA/06_Jackfruit/abiotic/Senescence/image_7.jpg",  # 请替换实际文件名
    "RAW_DATA/06_Jackfruit/biotic/Leaf_Miner/image_8.jpg",
    # 07_Mazie (玉米)
    "RAW_DATA/07_Mazie/biotic/Corn_Gray_leaf_spot/image_a.jpg",  # 请替换实际文件名
    "RAW_DATA/07_Mazie/abiotic/Nitrogen/image_b.jpg",
    # 08_Wheat (小麦)
    "RAW_DATA/08_Wheat/abiotic/Ndeficient/image_9.jpg",  # 请替换实际文件名
    "RAW_DATA/08_Wheat/biotic/WheatLeafRust/image_10.jpg",
    # 09_AloeVera (库拉索芦荟)
    "RAW_DATA/09_AloeVera/abiotic/Sunburn/image_11.jpg",  # 请替换实际文件名
    "RAW_DATA/09_AloeVera/biotic/Aloe Rust/image_12.jpg",
]
