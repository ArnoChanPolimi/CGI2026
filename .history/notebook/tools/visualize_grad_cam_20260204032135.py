...
def main():
    ...
    # ]
    images_to_test = [
        "data_processed/test/biotic/0a146952-538a-41e5-a422-b5d50e91771e___Matt.S_CG 6079_tile_2.jpg",
        "data_processed/test/biotic/1 (94)_tile_4.jpg",
        "data_processed/test/biotic/1 (160)_tile_3.jpg",
        "data_processed/test/biotic/2025_03_06_14_44_IMG_3571_tile_4.jpg",
        "data_processed/test/biotic/IMG_2486_tile_6.jpg",
        "data_processed/test/biotic/IMG_20230817_154441_tile_3.jpg",
        "data_processed/test/biotic/IMG-20230816-WA0001_tile_1.jpg",
        "data_processed/test/biotic/IMG20230817160435_tile_4.jpg",
        "data_processed/test/biotic/Leaf_Miner_31_tile_3.jpg",
        "data_processed/train/abiotic/IMG20230817155123_tile_5.jpg",
        "data_processed/test/abiotic/2025_03_06_15_05_IMG_3803_tile_2.jpg",  # abiotic
        "data_processed/test/abiotic/IMG20230814100753_tile_2.jpg",  # abiotic
        "data_processed/test/abiotic/Magnesium Deficiency_256_tile_4.jpg",  # abiotic
        "data_processed/test/abiotic/Nutrition Deficiency00132_tile_3.jpg",  # abiotic
    ]
    ...
    for rel_path in tqdm(images_to_test):
        ...
        with torch.enable_grad():
            # 获取 0 层 (浅层特征：轮廓/纹理)
            cam0_obj = GradCAM(model, model.features[3])
            mask0 = cam0_obj(input_tensor)
            cam0_obj.release()

            # --- 新增：获取 13 层 (中深层特征) ---
            cam13_obj = GradCAM(model, model.features[10])
        ...
        axes[1].set_title("Layer 3 (Edges)")

        # 第 3 列：Layer 13 (新增)
        axes[2].imshow(get_res(mask13, base_img_rgb))
        axes[2].set_title("Layer 10 (Mid-Features)")
        # 第 4 列：Layer 16
